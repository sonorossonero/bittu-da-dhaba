...
export default function Blog () {
  const { setOpenBlogDetail } = useContext(bittuContext);
  return (
    <section className={styles.blog}>
      <div className="container">
        <div className={styles.container}>
          <div className={styles.bgIcon}></div>
          <Title text="Blogs" title="ｂι𝕋ŤỮ ժ𝔞 𝖉𝖍𝖆𝖇𝖆 updates" />
...
const CardItem = forwardRef(({ title, text, data, author, link, card, setOpenBlogDetail }, ref) => (
