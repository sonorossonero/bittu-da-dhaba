...
export default function Hero () {
  const { ref } = useContext(bittuContext);
  const pagination = {
    type: 'fraction',
    clickable: true,
        ...
        <div className={styles.container}>
          <div className={styles.contant}>
            <div className={styles.logo}>
              <p className={styles.logoText}>Pure desi ghee !!</p>
              <div className={styles.logoImg}><img src={logo} alt="logo" /></div>
            </div>
            <h2 className={styles.title}>Snacks , Meals & Thali</h2>
            <p className={styles.text}>Our menu include a variety of items from North-Indian to South-Indian food , from Desi saag to Western Cuisine &  Fast food to tradition thali.</p>
