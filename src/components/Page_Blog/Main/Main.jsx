...
export default function Main () {
  const { setOpenBlogDetail, location } = useContext(bittuContext);
  return (
      ...
      <div className={styles.categoriesContent}>
        <ul className={styles.contentList}>
          <li className={styles.contentItem}>
            <p className={styles.itemText}>Photos</p>
            <span></span>
            <p>(1)</p>
          </li>
          <li className={styles.contentItem}>
            <p className={styles.itemText}>Recipes</p>
            <span></span>
            <p>(2)</p>
          </li>
          <li className={styles.contentItem}>
            <p className={styles.itemText}>Home-made Masalas</p>
            <span></span>
            <p>(3)</p>
          </li>
        </ul>
